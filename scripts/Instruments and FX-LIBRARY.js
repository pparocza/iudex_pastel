...
playLoopAtTime: function(freq, time){
		...
		amplitudeEnvelope.loop = true;
		filterEnvelope.loop = true;
...
FilterFade.prototype = {
	...
	startAtTime: function(fadeTarget, filterFreq, time){
		...
		this.fadeConstantFilter.biquad.frequency.setValueAtTime(this.filterFreq, this.now+this.time);
		this.fadeConstantGain.gain.gain.setValueAtTime(this.fadeTarget, this.now+this.time);
